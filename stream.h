...
uint8_t stream_write(struct stream *stream, void *ptr, size_t size);
uint8_t stream_write_buffer(struct stream *stream, struct buffer *buffer);
uint8_t stream_write_uint8(struct stream *stream);
uint16_t stream_write_big_uint16(struct stream *stream);
uint32_t stream_write_big_uint32(struct stream *stream);
