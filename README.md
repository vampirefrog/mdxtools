...
| @0xf8@ | length |\4.| Sound length | ???????? |
| @0xf7@ |\5. | Disable key off | ???????? |
| @0xf6@ | repeat | @0x00@ |\3. | Repeat start | ???????? |
| @0xf5@ |\2. offset |\3. | Repeat end | ???????? |
| @0xf4@ |\2. offset |\3. | Repeat escape | ???????? |
| @0xf3@ |\2. detune |\3. | Detune semitone/64 |
| @0xf2@ |\2. shift |\3.| Portamento semitone/16384 | ???????? |
| @0xf1@ | @0x00@ |\4. | Performance end |
| @0xf1@ |\2. loop |\3. | Repeat from loop.w |
| @0xf0@ | delay |\4. | Key-on delay |
| @0xef@ | channel |\4. | Sync send |
| @0xee@ |\5. | Sync wait |
| @0xed@ | freq |\4. | ADPCM / noise frequency setting | ???????? |
|/3. @0xec@ | @0x80@ |\4.| LFO Pitch MPOF |
| @0x81@ |\4.| LFO Pitch MPON |
| wave |\2. period |\2. change | LFO Pitch control|
|/3. @0xeb@ | @0x80@ |\4. | LFO Volume MAOF |
| @0x81@ |\4.| LFO Volume MAON |
| wave |\2. period |\2. change | LFO Volume control|
|/3. @0xea@ | @0x80@ |\4.| LFO OPM MHOF |
| @0x81@ |\4.| LFO OPM MHON |
| sync/wave | lfrq | pmd | amd | pms/ams | LFO OPM control |
| @0xe9@ | delay |\4.| LFO delay setting |
| @0xe8@ |\5. | PCM8 expansion/ mode shift | ???????? |
| @0xe7@ | @0x01@ | speed |\3.| Fade-out |
